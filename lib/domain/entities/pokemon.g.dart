...
extension PokemonQueryWhere on QueryBuilder<Pokemon, Pokemon, QWhereClause> {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterWhereClause> isarIdGreaterThan(
    Id isarId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterWhereClause> isarIdLessThan(
    Id isarId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PokemonQueryFilter
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFrontIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'spriteFront', value: ''),
      );
    });
  }
  ...
  spriteFrontIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'spriteFront', value: ''),
      );
    });
  }
}
